...
class LayoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create layout" do
    assert_difference('Layout.count') do
      post layouts_url, params: { layout: { floorplan_id: @layout.floorplan_id, note: @layout.note, product_id: @layout.product_id, quantity: @layout.quantity, room_name_id: @layout.room_name_id } }
    end
  ...
  test "should update layout" do
    patch layout_url(@layout), params: { layout: { floorplan_id: @layout.floorplan_id, note: @layout.note, product_id: @layout.product_id, quantity: @layout.quantity, room_name_id: @layout.room_name_id } }
